            ...
            <div class="row">
                <div class="col-xs-2 s-pad">
                    <div class="bg-white admin-left-pane" style="padding:0 15px;">
                        <ul class="f-12">
                            <li class="active"><a href="" class="c-bright-green">Alumnus Administrator Portal</a></li>
                            <li><a href="" class="c-bright-green">Resume Settings</a></li>
                            <li><a href="alumnus_updates.html" class="c-bright-green">Updates Monitor</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="col-xs-5 s-pad">
                                    <div class="alumni-list pl-10 pr-10 border-right">
                                        <ul class="ptb-15 border-bot">
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/dale.png" alt="" class="pull-left mr-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/don.png" alt="" class="pull-left mr-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/gian.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/chris.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                                    <h4>Chris B. Olivo</h4>
                                                    <h5 class="mt-3 c-bright-green">Graduate: <span class="c-sdark">Bachelor of Science in Computer Science</span></h5>
                                                    <h6 class="mt-3 c-sdark">Batch 2014-2015</h6>
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/naks.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/yoyo.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/ryan.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/leo.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                            ...
                                            <li class="oh mb-24">
                                                <img src="../images/batchmates/rustom.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                            ...
                                            <li class="oh mb-15">
                                                <img src="../images/batchmates/kate.png" alt="" class="pull-left mr-15">
                                                <div style="padding-top:0px;" class="mb-15">
                                                            ...
                                                            <div class="body" style="border-bottom:none;">
                                                                <ul>
                                                                    <li>
                                                                        ...
                                                                        <h5 class="c-dark">Male</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Birth Date</h6>
                                                                        <h5 class="c-dark">September 10, 1993</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Birth Place</h6>
                                                                        <h5 class="c-dark">MJ Santos Hospital, Montilla Boulevard, Butuan City, Agusan del Norte</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Age</h6>
                                                                        <h5 class="c-dark">23</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Nationality</h6>
                                                                        <h5 class="c-dark">Filipino</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Marital Status</h6>
                                                                        <h5 class="c-dark">Single</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Mobile #</h6>
                                                                        <h5 class="c-dark">+63265532565</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Telephone #</h6>
                                                                        <h5 class="c-dark">225-9868</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Email</h6>
                                                                        <h5 class="c-dark">dondondon@gmail.com</h5>
                                                                    </li>
                                                                    <li>
                                                                        <h6 class="c-light f-12">Religion</h6>
                                                                        <h5 class="c-dark">Roman Catholic</h5>
                                                                    </li>
                                                                    <li>
